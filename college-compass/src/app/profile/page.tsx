        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-3">
            <Field id="majors" label="Intended majors (comma-separated)">
              <input id="majors" className="field" value={csv(p.intendedMajors)} onChange={(e) => updateProfile({ intendedMajors: parseCsv(e.target.value) })} />
            </Field>
          </div>
        </div>
      </section>
      ...
      <section className="card p-6" aria-labelledby="pref-h">
        ...
        <div className="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Field id="prefStates" label="Preferred states (comma-separated)">
            <input id="prefStates" className="field" value={csv(p.preferredStates)} onChange={(e) => updateProfile({ preferredStates: parseCsv(e.target.value).map((s) => s.toUpperCase()) })} />
          </Field>
          ...
          <div className="sm:col-span-2">
            <Field id="ecs" label="Extracurricular activities (comma-separated)">
              <input id="ecs" className="field" value={csv(p.extracurriculars)} onChange={(e) => updateProfile({ extracurriculars: parseCsv(e.target.value) })} />
            </Field>
          </div>
        </div>
      </section>
